...
fn test_ty2_deriv_1() {
  ...
  let lexer = HLexer::new(r"let x1 = 1.0; let x2 = x1; let x3 = 3.0; let f = \t -> x2; let y = f[x1]; d[y].x1");
  let parser = HParser::new(lexer);
  let htree = parser.parse().unwrap();
  let mut builder = LBuilder::default();
  let module = match builder._compile(htree, LCtxRef::default(), LTyctxRef::default()) {
...
fn test_ty2_deriv_2() {
  ...
  //let lexer = HLexer::new("let x1 = 1.0; let x2 = 2.0; let x3 = 3.0; let f = \\t. t + x2; let y = x1 + f[x1]; let dy = d[y]; dy.x1");
  //let lexer = HLexer::new("let x1 = 1.0; let x2 = 2.0; let x3 = 3.0; let f = \\t. x2; let df = d[f]; let dy = df[x1]; dy.x1");
  let lexer = HLexer::new(r"let x1 = 1.0; let x2 = x1; let x3 = 3.0; let f = \t -> t; let y = f[x2]; d[y].x2");
  let parser = HParser::new(lexer);
  let htree = parser.parse().unwrap();
  let mut builder = LBuilder::default();
  let module = match builder._compile(htree, LCtxRef::default(), LTyctxRef::default()) {
...
fn test_ty2_deriv_3() {
  ...
  let lexer = HLexer::new(r"let x1 = 1.0; let x2 = 2.0; let x3 = 3.0; let f = \t -> x2; let y = f[x1]; d[y].x2");
  let parser = HParser::new(lexer);
  let htree = parser.parse().unwrap();
  let mut builder = LBuilder::default();
  let module = match builder._compile(htree, LCtxRef::default(), LTyctxRef::default()) {
...
fn test_ty2_deriv_3_fails() {
  ...
  //let lexer = HLexer::new("let x1 = 1.0; let x2 = 2.0; let x3 = 3.0; let f = \\t. bot; let df = d[f]; let dy = df[x1]; dy.x1");
  //let lexer = HLexer::new("let x1 = 1.0; let x2 = 2.0; let x3 = 3.0; let f = \\t. bot; let y = f[x1]; let dy = d[y]; dy.x1");
  let lexer = HLexer::new(r"let x1 = 1.0; let x2 = 2.0; let x3 = 3.0; let f = \t -> x2; let y = f[x1]; d[y].x1");
  let parser = HParser::new(lexer);
  let htree = parser.parse().unwrap();
  let mut builder = LBuilder::default();
  let module = match builder._compile(htree, LCtxRef::default(), LTyctxRef::default()) {
...
fn test_ty2_deriv_4() {
  ...
  //let lexer = HLexer::new("let x1 = 1.0; let x2 = 2.0; let x3 = 3.0; let f = \\t. bot; let df = d[f]; let dy = df[x1]; dy.x1");
  //let lexer = HLexer::new("let x1 = 1.0; let x2 = 2.0; let x3 = 3.0; let f = \\t. bot; let y = f[x1]; let dy = d[y]; dy.x1");
  let lexer = HLexer::new(r"let x1 = 1.0; let x2 = 2.0; let x3 = 5; let f = \t, k -> t; let y = f[x1, x3]; d[y].x1");
  let parser = HParser::new(lexer);
  let htree = parser.parse().unwrap();
  let mut builder = LBuilder::default();
  let module = match builder._compile(htree, LCtxRef::default(), LTyctxRef::default()) {
...
fn test_ty2_deriv_5() {
  ...
  //let lexer = HLexer::new("let x1 = 1.0; let x2 = 2.0; let x3 = 3.0; let f = \\t. bot; let df = d[f]; let dy = df[x1]; dy.x1");
  //let lexer = HLexer::new("let x1 = 1.0; let x2 = 2.0; let x3 = 3.0; let f = \\t. bot; let y = f[x1]; let dy = d[y]; dy.x1");
  let lexer = HLexer::new(r"let x1 = 1.0; let x2 = 2.0; let x3 = 5; let f = \t, k -> t; let y = f[x2, x3]; d[y].x2");
  let parser = HParser::new(lexer);
  let htree = parser.parse().unwrap();
  let mut builder = LBuilder::default();
  let module = match builder._compile(htree, LCtxRef::default(), LTyctxRef::default()) {
...
fn test_ty2_deriv_6() {
  println!();
  let lexer = HLexer::new(r"let x = 3.0; let n = 5; let f = \t, k -> match k with | 0 => t | _ => t; let y = f[x, n]; d[y].x");
  let parser = HParser::new(lexer);
  let htree = parser.parse().unwrap();
  let mut builder = LBuilder::default();
  let module = match builder._compile(htree, LCtxRef::default(), LTyctxRef::default()) {
